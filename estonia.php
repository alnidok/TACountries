    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                <p>Эстония входит в европейские страны, подписавшие шенгенское соглашение, поэтому для въезда в страну необходимо оформить <strong>Шенгенскую визу</strong> категории С. Для частых путешественников можно подать документы на мультивизу длительностью полгода или год.</p>
                <div class="card bg-secondary">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><i class="icon-link"></i> <a href="http://www.astana.vm.ee/rus/posolstvo" target="_blank" rel="nofollow">astana.vm.ee</a></p>
                    </div>
                </div>
                <div class="card">
...
<section id="custom" class="bg-white">
    <div class="container">
        ...
        <p>В Эстонию разрешено привозить  100 г чая,  500 г кофе, 50 мл духов или 250 мл туалетной воды. Золото и драгоценности не более чем на 500 г. Антиквариат можно вывозить только в сопровождении соответствующих документов. Ограничения на провоз личных вещей нет.</p>

        <h5>Tax Free</h5>
        Вернуть НДС 20% с покупок можно на территории аэропорта или вокзала, также есть пункт возврата на границе в Нарве. Для этого необходимо предъявить соответствующие чеки из магазинов, участвующих в этой системе на сумму свыше 39 евро.
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <p>Стоит также отметить, что в Таллинне для жителей города - автобусы, троллейбусы, трамваи и электрички - бесплатные. Подробнее об этом можно узнать <a href="https://www.tallinn.ee/rus/pilet/Informatsija-o-proezdnyh-biletah" target="_blank" rel="nofollow">на официальном сайте</a>.</p>
...
<section id="auto" class="bg-white">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <p>Дороги в стране находятся на высоком уровне, движение левостороннее, жители привыкли соблюдать правила дорожного движения.</p>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <ul>
                    <li>Tele2 - <a href="https://tele2.ee/ru/" target="_blank" rel="nofollow">перейти на сайт</a></li>
                    <li>EMT - <a href="https://www.telia.ee/ru/" target="_blank" rel="nofollow">перейти на сайт</a></li>
                    <li>Elisa - <a href="https://www.elisa.ee/ru/" target="_blank" rel="nofollow">перейти на сайт</a></li>
                </ul>
...
<section id="prices">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <p>Цены на жилье в Эстонии начинаются с 10 евро за комнату в хостеле. Чтобы остановится в простом отеле, необходимо будет отдать минимум 40 евро за двухместный номер. В 5* отеле цены начинаются от 155 евро и выше. Стоимость курса лечения в санатории с проживанием стартует от 150 евро.</p>
