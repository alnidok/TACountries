            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/hs2HMcbqJ7g?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">TUNISIA IN A TIMELAPSE
                        <br>© ishoot studio 2016</figcaption>
                </figure>
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/eiUMgxNrp5Y?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Тунис 🍅 Мировой рынок 🌏 Моя Планета
                        <br>© Моя Планета 2016</figcaption>
                </figure>
            </div>
        </div>
    </div>
