            ...
            <div class="col-12">
                <div class="space-lg pb-0">
                    ...
                    <div class="lead">
                        ...
                        <b>Часовой пояс</b>: GMT+9. Разница с Астаной +3 часа.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-footer p-3">
                        <a href="https://booking.scat.kz/websky/#/search" class="btn btn-block btn-outline-success" target="_blank" rel="nofollow">Подобрать рейс</a>
                    </div>
                </div>
            </div>
        </div>
