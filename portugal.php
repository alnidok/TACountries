    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                <p>В Португалии правостороннее дорожное движение.</p>
                <h5>Аренда авто</h5>
                <p>В Португалии фирмы по прокату автомобилей вас встретят прямо в аэропорту. Прилетев, вы можете взять машину и отправится сразу исследовать страну. Для этого потребуются только ваши права международного образца, опыт вождения от года и возраст старше 21, а в некоторых фирмах 25 лет. При получении машины зафиксируйте все имеющиеся повреждения, заполните договор и проверьте наличие всех необходимых документов и страховки на машину как на сам автомобиль, так и автогражданскую отвественность. Так вы сможете избежать проблем во время путешествия.</p>
            </div>
            <div class="col-md-4">
