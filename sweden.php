            ...
            <div class="col-12 col-lg-6">
                <div class="space-lg pb-0">
                    ...
                    <div class="lead">
                        ...
                        <b>Часовой пояс</b>: от GMT +1. Разница с Астаной -5 часов. Есть переход на летнее и зимнее время.
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-6">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <nobr>230 В</nobr>, <nobr>50 Гц</nobr>. Используются разъемы <a href="/journal/electric-sockets.html#typeG">типа С</a> и <a href="/journal/electric-sockets.html#typeG">типа F</a>
                                </div>
