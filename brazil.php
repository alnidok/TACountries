                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <nobr>220 В</nobr> и <nobr>127 В</nobr>, <nobr>60 Гц</nobr>. Используется <a href="/journal/electric-sockets.html#typeN">разъем типа N</a>, но встречаются также розетки типов A, B и C.
                                </div>
                                <span class="text-right">
                                    <img src="/img/electric/type_n.png" style="width:100px; max-width:100%;">
                                </span>
                            </div>
                        </li>
                    </ul>
