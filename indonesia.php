            ...
            <div class="col-lg-6">
                <div class="space-lg pb-0">
                    ...
                    <div class="lead">
                        ...
                        <b>Часовой пояс</b>: от GMT +7 до GMT +9. Разница во времени с Астаной 1-3 часа.
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <nobr>220 В</nobr>, <nobr>50 Гц</nobr>, используется <a href="/journal/electric-sockets.html#typeC">разъем типа С</a>
                                </div>
