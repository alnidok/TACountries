        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <ul>
                    ...
                    <li>вне населенного пункта - 80 км/ч (с прицепом 80 км/ч)</li>
                    <li>на автомобильной дороге - 100 км/ч (с прицепом 90 км/ч)</li>
                    <li>на автомагистрали - 130 км/ч (с прицепом 90 км/ч)</li>
                </ul>
            </div>
            <div class="col-md-4">
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <p>В стране три крупных оператора связи:</p>
                <ul>
