        ...
        <div class="row justify-content-between align-items-center space-lg pb-0">
            <div class="col-lg-6">
                ...
                <div class="lead">
                    <b>Столица</b>: Ташкент
                    <br>
                    <b>Официальный язык</b>: узбекский
                    <br>
                    <b>Валюта</b>: UZS — узбекский сум
                    <br>
                    <b>Территория</b>: 447 400 км²
                    <br>
                    <b>Население</b>: 31,8 млн. человек
                    <br>
                    <b>Часовой пояс</b>: UTC+5. Разница во времени между Узбекистаном и Астаной +1 час
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                <p>Как и любой восточный город Ташкент славится множеством городских рынков и базаров. Самые известные среди них — Чорсу и Эски-Жува. Здесь огромный выбор текстиля, посуды, ковров, сладостей, сухофруктов, меда и орехов, риса и много другого.</p>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                <p>Для граждан Республики Казахстан въезд на территорию Узбекистана является безвизовым, пребывание в стране сроком до 5 дней регистрации не требует, свыше 5 дней — необходима регистрация (временная прописка) по месту проживания.</p>
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <i class="icon-v-card mr-1"></i> Регистрация обязательна (при пребывании свыше 5 дней)
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <h5>Автобусы</h5>
                <p>Автотранспорт в стране представлен как междугородними, так и городскими автобусами. Проезд осуществляется по проездному билету, причем необходимо учесть, что помимо государственных маршрутов, существуют частные, на которых проездные не действительны, а оплата производится непосредственно в автобусе.</p>
                <h5>Такси</h5>
