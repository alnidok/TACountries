            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        <img alt="Вьетнам / Таймлапсы / Ночное небо / Закаты / рассветы / Vietnam Above the Roofs" src="https://i.ytimg.com/vi/2EKk-2ztDFQ/hqdefault.jpg"
                            class="bg-image" />
                        <div class="video-play-icon">
                            <i class="icon-controller-play"></i>
                        </div>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/2EKk-2ztDFQ?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Вьетнам / Таймлапсы / Ночное небо / Закаты / рассветы / Vietnam Above the Roofs
                        <br>© Travel Hacking! 2017</figcaption>
                </figure>
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/Q4JefVxxGII?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Вьетнам - 3 выпуск (1080p HD) | Мир Наизнанку
                        <br>© МИР НАИЗНАНКУ 2013</figcaption>
                </figure>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between mt-5">
            <div class="col-12 col-md-8 col-lg-7">
                ...
                <p>Смелые туристы могут отведать экзотику: стейки из крокодила и страуса, лягушачьи лапки, запеченое сердце кобры.</p>
            ...
            <div class="col-12 col-md-4">
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/uDDKJTSVI7A?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Про Вьетнамские Донги | Деньги Вьетнама | Валюта Вьетнама
                        <br>© Про Вьетнам 2015</figcaption>
                </figure>
...
<section id="visa" class="bg-white">
    <div class="container">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-md-4">
                <div class="card">
                    <iframe src="https://www.google.com/maps/embed/v1/search?q=астана,+ул.+жылыой,+19б&key=AIzaSyBy4GyZglz_6mltKrjCVr0S1Vb33LHTJf4"
                        allowfullscreen class="card-img-top w-100"></iframe>
                    <div class="card-body">
                        <h5>Посольство Вьетнама</h5>
                        <p>Астана, ул. Жылыой, 19Б</p>
                        <p>
                            <i class="icon-phone"></i> +7 (7172) 26–61–62</p>
                        <p>
                            <i class="icon-link"></i>
                            <a href="http://www.mofa.gov.vn" target="_blank">www.mofa.gov.vn</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/1u0SDQlj2bY?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Вьетнам Нячанг 2016 май 27.Как переходить дорогу?
                        <br>© Ринат из Вьетнама 2016</figcaption>
                </figure>
            </div>
        </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <figure class="figure d-block">
                    <div class="video-cover box-shadow">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://www.youtube.com/embed/RmVaQPvmz_4?autoplay=1&rel=0&showinfo=0" webkitallowfullscreen
                                mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-right">Мобильная связь во Вьетнаме | Про Вьетнам
                        <br>© Про Вьетнам 2015</figcaption>
                </figure>
            </div>
        </div>
