    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <p>Работает роуминг, а также имеется возможность аренды сотовых телефонов местного оператора <a href="http://www.etecsa.cu/?page=inicio" target="_blank" rel="nofollow">перейти на сайт</a>.</p>
