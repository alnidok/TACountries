            ...
            <div class="col-lg-6">
                <figure class="figure d-block">
                    <div class="video-cover box-shadow mb-0">
                        <img alt="Magnetic Latvia Travel 60SEK" src="https://i.vimeocdn.com/video/690020572_1280x720.jpg" class="bg-image"/>
                        <div class="video-play-icon">
                            <i class="icon-controller-play"></i>
                        </div>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" data-src="https://player.vimeo.com/video/261107829?autoplay=1" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        </div>
                    </div>
                    <figcaption class="figure-caption text-light text-right">© Eaglewood Films, 2018</figcaption>
                </figure>
            </div>
        </div>
    </div>
...
<section id="population">
    <div class="container">
        <h2>Население</h2>
        <p>Население Латвии многонационально, начиная с 1991 года постепенно уменьшается и стареет за счет естественного оттока молодых людей в страны западной Европы. Сегодня в стране живут около 60% латышей, 25% русских, и 15% других национальностей (поляки, украинцы, белорусы, немцы, эстонцы и литовцы).</p>
        <p>Мужчин и женщин примерно поровну. Средняя продолжительность жизни в Латвии - 75 лет. У женщин она составляет 80 лет, у мужчин – 70 лет.</p>
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><i class="icon-link"></i> <a href="http://www.mfa.gov.lv/kazakhstan" target="_blank" rel="nofollow">mfa.gov.lv</a></p>
                    </div>
                </div>
                <div class="card">
...
<section id="security">
    <div class="container">
        <h2>Безопасность</h2>
        <p>Латвия - это спокойная страна на северо-востоке Европы. Маленький размер и гостеприимные жители делают ее безопасной и комфортной для пребывания. Здесь нет районов, в которые нельзя заходить, но и расслабляться совсем не нужно. Элементарные правила безопасности стоит соблюдать везде.</p>
        ...
        <p>По количеству дорожных происшествий Латвия одна из самых благополучных стран Европы. Количество аварий здесь сокращается каждый год. За 2017 год на дорогах погибло 134 автомобилиста и 50 пешеходов, что значительно меньше, чем в предыдущие годы.</p>
...
<section id="custom" class="bg-white">
    <div class="container">
        ...
        <h5>Валюта</h5>
        <p>По таможенному законодательству Латвии в страну можно ввезти без декларирования 10000 евро, вывозить можно любую сумму. Деньги, находящиеся на банковских картах или в дорожных чеках, декларированию не подлежат.</p>

        <h5>Спиртное и сигареты</h5>
        <p>Табачные изделия ограничены как на ввоз, так и на вывоз. 1 человек старше 18 лет может ввезти 200 сигарет, или 50 сигар, или 100 сигарилл, или 250г табака. Также ограничен и алкоголь. Для провоза в обе стороны разрешен 1 л крепких напитков и 2 литра слабых, меньше 22 градусов.</p>

        <h5>Чай, кофе, туалетная вода, ювелирные украшения</h5>
        <p>В Латвию можно ввезти  100г чая,  500г кофе, 50мл духов или 250мл туалетной воды. Золото и драгоценности не более чем на 500г. Вывоз драгоценностей свыше 500г декларируется, провоз необработанного янтаря запрещен. На все ценности старше 50 лет, относящиеся к антиквариату, необходимо получить разрешение на вывоз.</p>

        <h5>Tax Free</h5>
        <p>Вернуть налог на товары 18%, купленные на территории Латвии, можно на территории аэропорта. Для этого потребуются заполненные квитанции из магазина на сумму больше 44 евро и паспорт.</p>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <h5>Такси </h5>
                <p>На улицах Риги множество стоянок такси. Свободную машину можно поймать и простым поднятием руки или же вызвать по телефону, что окажется несколько дешевле. Средний тариф — 0,70-0,90 EUR за посадку плюс 0,30-0,60 EUR за каждый км. Доехать из аэропорта до города можно за 15 евро.</p>
            </div>
                ...
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>АИ-95</div>
                                <span>1.22 EUR/литр</span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>АИ-98</div>
                                <span>1.275 EUR/литр</span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>Дизель</div>
                                <span>1.14 EUR/литр</span>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>Газ (LPG)</div>
                                <span>0.525 EUR/литр</span>
                            </div>
                        </li>
                    </ul>
                </div>
...
<section id="auto" class="bg-white">
    <div class="container">
        <h2>Автомобиль</h2>
        <p>В Латвии установлены следующие скоростные ограничения:</p>
        <ul>
            <li>в населенных пунктах — 50 км/ч, в жилой зоне, на заправочных станциях и парковках — 20 км/ч;</li>
            <li>за городом — 90 км/ч;</li>
            <li>за пределами населенных пунктов:
                <ul>
                    <li>для транспортных средств массой до 7,5 тонн — 90км/ч,</li>
                    <li>для транспортных средств массой более 7,5 тонн — 80 км/ч</li>
                </ul>
            </li>
        </ul>
        <p>Вождение транспортного средства в состоянии алкогольного опьянения (> 0,5 <span title="промилле">‰</span>) запрещено.</p>
...
<section id="health">
    <div class="container">
        ...
        <p>В Латвию часто приезжают в санатории или бальнеологические курорты для оздоровления минеральными водами. Источники в основном расположены на побережье, лучшие курорты находятся в Юрмале. Летом лечение сопровождается купанием в прохладном Балтийском море и прогулкой по сосновым лесам с целебным воздухом.</p>
    ...
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-7">
                ...
                <p>Мобильная связь в стране представлена 3 сотовыми операторами.</p>
                <ul>
                    <li>Теле2 - <a href="https://www.tele2.lv/ru/" target="_blank" rel="nofollow">перейти на сайт</a></li>
                    <li>LMT - <a href="https://www.lmt.lv/ru/" target="_blank" rel="nofollow">перейти на сайт</a></li>
                    <li>Bite - <a href="https://www.bite.lv/ru" target="_blank" rel="nofollow">перейти на сайт</a></li>
                </ul>
                <p>Сим-карты можно купить в фирменном офисе, предоставив паспорт. А карты пополнения продаются в любом киоске, на заправке и в супермаркете. Стоимость звонков за пределы Евросоюза будут стоить от 0.5 евро за 1 мин, звонки в Европу дешевле, выгоднее всего брать пакеты по 30 мин за 4 евро или 60 мин за 6 евро.</p>

                <h5>Интернет</h5>
                <p>Точки Wi-Fi распространены в Риге, Юрмале. Бесплатная городская сеть называется Lattelecom Wi-Fi. Для подключения нужно посмотреть рекламу, после чего соединение будет установлено на 30 мин. Через полчаса можно переподключиться заново. Скорость интернета достаточная для общения в мессенджерах и просмотра любых интернет-сайтов.</p>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-md-6">
                ...
                <p>Цены на еду в кафе и ресторанах начинаются от 7 евро за недорогой обед. Поужинать в уютном ресторанчике старого города выйдет 35-50 евро с бокалом вина. А заглянуть на обед в макдональдс можно на 5 евро.</p>
            </div>
