...
<section id="asia">
    <div class="container">
        ...
        <ul style="column-count: 3;">
            ...
            <li>Лаос</li>
            <li>Ливан</li>
            <li><a href="/guide/malaysia">Малайзия</a></li>
            <li><a href="/guide/maldives">Мальдивские острова</a></li>
            <li><a href="/guide/mongolia">Монголия</a></li>
            <li><a href="/guide/myanmar">Мьянма</a></li>
...
<section id="europe" class="bg-white">
    <div class="container">
        ...
        <ul style="column-count: 3;">
            ...
            <li><a href="/guide/albania">Албания</a></li>
            ...
            <li><a href="/guide/denmark">Дания</a></li>
            <li><a href="/guide/ireland">Ирландия</a></li>
            <li><a href="/guide/iceland">Исландия</a></li>
            ...
            <li><a href="/guide/romania">Румыния</a></li>
            <li>Сан-Марино</li>
            <!--<li>Северный Кипр</li>-->
            <li><a href="/guide/serbia">Сербия</a></li>
            ...
            <li><a href="/guide/croatia">Хорватия</a></li>
...
<section id="africa" class="bg-white">
    <div class="container">
        ...
        <ul style="column-count: 3;">
            ...
            <li>Уганда</li>
            <li>Эфиопия</li>
            <li><a href="/guide/south_africa">ЮАР</a></li>
        </ul>
    </div>
</section>