...
<section id="culture">
    <div class="container">
        ...
        <p><i class="icon-link"></i> Министерство Культуры Болгарии - <a href="http://mc.government.bg/" target="_blank">mc.government.bg</a></p>
        ...
        <div class="row justify-content-between">
            <div class="col-12 col-md-8 col-lg-7">
                ...
                <p class="mt-2 small">
                    ...
                    * Представленные данные являются ознакомительными, за более точной информацией нужно обращаться в визовый центр.
                </p>
            </div>
